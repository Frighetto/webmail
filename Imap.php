...
class Imap {
    ...
    public function searchByText($text){
        return imap_search($this->imap, 'SUBJECT "' . $text . '"');
    }
...
*/
    ...
    public function getHeader($folder, $index) {
        $header = imap_headerinfo($this->imap, $index); 
