        ...
        <div id="login-area" style="height: 100%">
            <div class="container">       
                <form method="POST" class="form-signup">                                                
                    <input id="loginusername" name="username" value="" type="text" class="form-control input-lg" placeholder="Usuário" required autofocus>
                    <input id="loginpassword" name="password" value="" type="password" class="form-control input-lg" placeholder="Senha" required>                                
