...
$smtp_server = "mail.teleatendimento.com.br";
$smtp_port = 465;
...
$comand = 'curl --user "teste@teleatendimento.com.br:&lBCEyO8,C*y" --url "imaps://mail.teleatendimento.com.br:993/INBOX;MAILINDEX=5"';
$output = null;
exec($comand, $output);
