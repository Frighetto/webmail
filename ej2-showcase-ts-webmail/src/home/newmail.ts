...
function createMailForm(): void {
    ...
    let ccoButton: Button = new Button();
...
function clearMailForm(): void {
    ...
    (document.getElementById('autoTo') as HTMLInputElement).value = '';
    (document.getElementById('autoCc') as HTMLInputElement).value = '';
    (document.getElementById('autoCco') as HTMLInputElement).value = '';
...
export function showMailDialog(option: string, selectedMessage: { [key: string]: Object }): void {    
    ...
    if (selectedMessage) { 
        if(option == "Draft"){
            key = 'CCMail';
            (document.getElementById('autoCc') as HTMLInputElement).value = selectedMessage[key].toString();
            key = 'Email';
            (document.getElementById('autoTo') as HTMLInputElement).value = selectedMessage[key].toString();
            key = 'ContactTitle';
