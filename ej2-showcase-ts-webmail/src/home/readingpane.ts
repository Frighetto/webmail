...
export function bindReadingPaneData(selectedMessage1: {[key: string]: Object}): void {
    ...
    key = 'Image';
    (headerTitle.getElementsByClassName('logo-style2')[0] as HTMLElement).style.background =
    ...
    key = 'Message';
    /*
    document.getElementById('rp-accContent').innerHTML = currentMessageHtml; //selectedMessage[key].toString();    
    */
}
