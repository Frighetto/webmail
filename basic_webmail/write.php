    ...
    <div class="card card-primary card-outline">        
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">            
                ...
                <div class="form-group">
                    <input class="form-control" placeholder="Cc" value="<?= isset($cc) ? $cc : '' ?>" name="cc">
                </div>
                <div class="form-group">
                ...
                <div>    
                    ...
                    <button id="btnshowhtml" style="width: 50%;" onclick="showhtml()" class="btn btn-default btn-lg" type="button">HTML</button> 
                </div>                         
                ...
                <div id="htmleditor" hidden>
                    ...
                    <div>           
                        <textarea name="mailhtml" oninput="updatehtmlresult()" id="htmlcode" class="form-group" style="float: left; width: 50%; min-height: 360px; max-height: 360px;" contenteditable>
                        </textarea> 
                        <div id="htmlresult" class="form-group" style="border: dotted; float:left; width: 50%; min-height: 360px; max-height: 360px; overflow: auto">
                        </div>
                    </div> 
                </div>        
                ...
                <button onclick="anexo_extra()" type="button" class="btn btn-default"> + Anexo</button>
